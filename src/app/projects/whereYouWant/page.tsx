  ...
  return (
    <div className="flex flex-col px-2.5 gap-10 lg:px-30">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2">
        ...
        />
        <Image
          src="/img/projects/whereYouWant/kudaygodno_dk_2.webp"
          width={590}
          height={590}
          alt=""
        />
      ...
      />
      <Image
        src="/img/projects/whereYouWant/kudaygodno_dk_3.webp"
        width={590}
        height={590}
        alt=""
        className="w-full"
...
Мои основные задачи включали:
 ...
 — проектирование хедера и футера — ключевых навигационных элементов сайта.`}
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        ...
        />
        <Image
          src="/img/projects/whereYouWant/kudaygodno_dk_5.webp"
          width={590}
          height={590}
          alt=""
        />
        <Image
          src="/img/projects/whereYouWant/kudaygodno_dk_6.webp"
          width={590}
          height={590}
          alt=""
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        />
        <Image
          src="/img/projects/whereYouWant/kudaygodno_dk_8.webp"
          width={590}
          height={590}
          alt=""
        />
        <Image
          src="/img/projects/whereYouWant/kudaygodno_dk_9.webp"
          width={590}
          height={590}
          alt=""
        />
