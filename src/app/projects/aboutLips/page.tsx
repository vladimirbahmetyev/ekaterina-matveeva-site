...
— акцентировать внимание на преимуществах курса и результатах студентов; 
...
— создать учебную платформу на Tilda.`}
      ...
      <Info
        title={
          "После оформления покупки пользователю предоставляется доступ к учебнойплатформе, которую я также спроектировала на Tilda.В ней размещены видеоуроки, домашние задания и дополнительные материалы."
        }
        description={
