  ...
  return (
    <div className="flex flex-col px-2.5 gap-10 md:px-30">
      ...
      <Info
        ...
        description={`В приложении можно: 
— Отслеживать приём собственных лекарств и настраивать гибкое расписание уведомлений. 
— Проверять совместимость лекарств и получать подсказки о возможных противопоказаниях. 
— Контролировать приём медикаментов родственников (например, детей или пожилых членов семьи), даже если у них не установлено приложение.
 — Смотреть статистику и прогресс, мотивирующую пользователя завершать курс лечения до конца, а также можно поделиться распечаткой графика прёма лекарств с врачом. 
