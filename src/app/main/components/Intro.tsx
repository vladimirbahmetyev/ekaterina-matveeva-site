...
export const Intro = () => (
  <div className="px-4 md:px-30 h-screen w-full pb-10">
  <div className="flex gap-2 h-full justify-between ">
    ...
    <div className="mt-18 flex flex-col items-center justify-center gap-3 md:gap-6 ">
      <Text className="hidden md:block" variant="text" color='dark-beige'>Web · UI/UX designer</Text>
      <Image className="md:hidden mb-2" width={239} height={320} alt="kv" src={"/img/main/intro_mobile.png"}/>
      <Heading>Екатерина Матвеева</Heading>
      <Text className="text-center mb-3 md:mb-0" variant="h3" color='dark-beige'>
