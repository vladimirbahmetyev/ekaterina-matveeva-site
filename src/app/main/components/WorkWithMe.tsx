    ...
    >
      ...
      >
        <Card
          ...
          ref={ref_1 as RefObject<HTMLDivElement>}
        >
          <div className="relative flex flex-col justify-between h-full">
            ...
            <div className="max-w-[75%] flex flex-col gap-2">
              <Text color="dark-beige" variant="text">
                Чтобы сделать интерфейс интуитивным и удобным
              </Text>
              <Text color="beige" variant="text">
                JTBD, персоны, интервью, опросы, анализ конкурентов и аудитории
              </Text>
            </div>
          </div>
          <Image
        ...
        <Card
          ref={ref_2 as RefObject<HTMLDivElement>}
          variant="white"
        ...
        <Card
          variant="orange"
          className=""
          ref={ref_3 as RefObject<HTMLDivElement>}
        >
          <div className="flex flex-col justify-between h-full">
        ...
        <Card
          ref={ref_4 as RefObject<HTMLDivElement>}
          variant="filled"
        ...
        <Card
          ...
          ref={ref_5 as RefObject<HTMLDivElement>}
        >
          <div className="flex flex-col justify-between h-full">
        ...
        <Card
          ref={ref_6 as RefObject<HTMLDivElement>}
          variant="filled"
          ...
          <SwiperSlide>
            <Card variant="filled" className="h-[430px]">
              <div className="flex flex-col justify-between h-full">
                ...
                />
                <Text variant="text" color="beige">
                  Разрабатываю не только сайты, но и презентации, оформляю
                  соцсети, готовлю PDF-файлы— всё в едином стиле
                </Text>
              </div>
            </Card>
          </SwiperSlide>
            ...
            <Card className="h-[430px]" variant="filled">
              <div className="flex flex-col justify-between h-full">
                <div className="flex justify-between gap-3">
                  ...
                  <Image src={"/svg/group.svg"} alt="" width={61} height={51} />
                </div>
                <Text variant="text" color="beige">
                  Психологическое образование помогает мне проектировать
                  интерфейсы, вызывающие доверие и эмоции у пользователей
                </Text>
              </div>
            </Card>
          </SwiperSlide>
          <SwiperSlide>
            <Card className="h-[430px]" variant="filled">
              <div className="flex flex-col justify-between h-full">
                ...
                <Text variant="text" color="beige">
                  Соблюдаю дедлайны, остаюсь на связи, держу в курсе этапов
                  работы
                </Text>
              </div>
            </Card>
          ...
          <SwiperSlide>
            <Card variant="filled" className="h-[430px]">
              <div className="flex flex-col justify-between h-full">
                ...
                <Text variant="text" color="beige">
                  Изучаю бизнес, аудиторию и цели, чтобы дизайн точно решал
                  нужные задачи
                </Text>
              </div>
            </Card>
